...
交付事项 design-content-v020 为 needs-review。内容原型、P0 修复、详情目录和可视化 Markdown 编辑已实现、定向验证并提交，等待用户复核。
...
唯一下一步：用户刷新后打开或新建草稿，复核可视化编辑与源码切换。v0.2.0 保留任务分支，尚未合并或推送；根仓库原有技能改动不纳入任务提交。
